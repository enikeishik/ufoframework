...
use \Ufo\Core\Db;
use \Ufo\Core\Debug;
use \Ufo\StorableCache\BadPacketException;
use \Ufo\StorableCache\Packet;
use \Ufo\StorableCache\StorableCache;
use \Ufo\StorableCache\StorageConnectException;
 
class StorableCacheTest extends BaseUnitTest
{
    // tests
    ...
    public function testCacheArrayStorage()
    {
        ...
        $cache = new class($config, new Debug()) extends StorableCache {
            public $storage;
        };
    ...
    public function testCacheFilesStorage()
    {
        ...
        $this->expectedException(
            ...
            function() use($config) { $cache = new StorableCache($config, new Debug()); }
        );
